...
<!-- Favicon（Google-compliant：根路径 .ico 绝对 URL 最优先，确保 Googlebot-Favicon 直达；
     子页面无论从哪个路径被抓取，均能定位到唯一根路径图标；SVG/PNG 多尺寸适配现代浏览器/PWA） -->
<link rel="shortcut icon" href="${SITE_ORIGIN}/favicon.ico" type="image/x-icon">
<link rel="icon" href="${SITE_ORIGIN}/favicon.ico" type="image/x-icon">
